...
interface PayLater_PayLater_Core_Interface
{
	...
	const PAYLATER_WIDGET_JSON_AMDINHTML_LOCATOR = 'https://paylater.s3.amazonaws.com/3.0/js/widgets.json';
	const PAYLATER_WIDGET_JSON_FRONTEND_LOCATOR = 'https://paylater.s3.amazonaws.com/3.0/js/widgets.json';
