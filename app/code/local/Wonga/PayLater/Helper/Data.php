 ...
 */
class Wonga_PayLater_Helper_Data extends Mage_Core_Helper_Data implements Wonga_PayLater_Model_Interface_PayLater
{
	/**
	 *
	...
	public function getInflector()
	{
		if (!isset($this->_inflector)) {
			$this->_inflector = new Wonga_PayLater_Helper_Inflector();
		}
