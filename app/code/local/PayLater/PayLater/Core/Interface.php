...
interface PayLater_PayLater_Core_Interface
{
	...
	const PAYLATER_WIDGET_JSON_AMDINHTML_LOCATOR = 'https://s3-eu-west-1.amazonaws.com/paylater/widgets.json';
	const PAYLATER_WIDGET_JSON_FRONTEND_LOCATOR = 'https://s3-eu-west-1.amazonaws.com/paylater/widgets.json';
